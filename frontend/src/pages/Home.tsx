...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* HERO SECTION */}
      <section className="mx-auto flex min-h-[calc(100vh-64px)] max-w-7xl flex-col items-center gap-10 px-6 py-16 lg:flex-row">
        <div className="flex-1">
          ...
          <h1 className="text-5xl font-extrabold leading-tight text-slate-900 lg:text-6xl">
            Lost Something? <br />
            <span className="text-orange-500">Find It.</span> <br />
            Return It.
          </h1>

          <p className="mt-6 max-w-xl text-lg text-slate-600">
            ReturnX helps employees report lost items, discover found belongings,
            and safely reconnect items with their rightful owners.
          </p>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              to="/found-items"
              className="flex items-center gap-2 rounded-xl border border-orange-500 px-6 py-3 font-semibold text-orange-600 transition hover:bg-orange-50"
            >
              Find Item
              <Search size={18} />
            </Link>
