        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-lg text-orange-100">
              Manage your claimed items, verify ownership, and complete the
              return process through secure communication.
            </p>
          </div>

          <div className="rounded-2xl bg-white/20 px-8 py-5 backdrop-blur">
            <p className="text-sm text-orange-100">Active Claims</p>
            <p className="text-4xl font-bold">{claims.length}</p>
          </div>
        </div>
      </section>
...
const Data = ({ icon, title, value }: DataProps) => (
